...
(function (arrOfTasks) {
	...
	let lastSelectedTheme = localStorage.getItem('applicationTheme') || 'default'

	const listContainer = document.querySelector('.tasks-list-section .list-group')

	const form = document.forms['addTask'] // значение атрибута name
	...
	function renderAllTasks(tasksList) {
		if (!tasksList) {
			console.error('Transfer a list of tasks')
			return
		}
	...
	function onThemeSelect(e) {
		...
		localStorage.setItem('applicationTheme', selectedTheme)
	}
